      ...
      <el-tabs value="basic" type="border-card">
        <el-tab-pane label="基本信息" name='basic'>
          ...
          <el-form-item label="类型">
            ...
            <!-- <el-input v-model="model.categories"></el-input>   -->
          </el-form-item>
          <el-form-item label="难度">
            <el-rate style="margin-top: 0.6em;" :max='9' show-score v-model="model.scores.difficult"></el-rate>  
          </el-form-item>
          <el-form-item label="技能">
            <el-rate style="margin-top: 0.6em;" :max='9' show-score v-model="model.scores.skills"></el-rate>  
          </el-form-item>
          <el-form-item label="攻击">
            <el-rate style="margin-top: 0.6em;" :max='9' show-score v-model="model.scores.attack"></el-rate>  
          </el-form-item>
          <el-form-item label="生存">
            <el-rate style="margin-top: 0.6em;" :max='9' show-score v-model="model.scores.survive"></el-rate>  
          </el-form-item>
